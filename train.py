...
if __name__ == '__main__':
    ...
    parser.add_argument("-bd", "--bidirectional", type=str, default="False")  # 双向
    ...
    # 训练和测试lstm模型的数据
    parser.add_argument("-trf", "--train_lstm_file", type=str, default="split_files/regression_test_sample.csv")
    parser.add_argument("-tef", "--test_lstm_file", type=str, default="split_files/regression_train_sample.csv")
