...
def doit(ind,sequence_list):
    ...
    gc.collect()
    # 保存生成的结构化数
    writeDataToExcleFile(sequences, peptides_descriptors, ('E:/code_available/structured_data/7_peptide_7_' + str(ind) + '.csv'))
...
if __name__ == "__main__":
    file_path = r"E:\code_available\7_peptide_result\7_peptide_rule_0.txt" # 2657205/166075
    print(file_path)
